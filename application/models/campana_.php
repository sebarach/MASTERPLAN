...
class campana extends CI_model {
    ...
    function campana_cadenas($id_campana){
      $res=$this->db->query("execute [campana_cadenas] ".$id_campana);
      return $res->result_array();
    }
    ...
    function carpetas($id_campana){
      $res=$this->db->query("execute [carpetaslist] ".$id_campana."");
      return $res->result_array();
    }
    ...
    function editarDocumento($nombreDoc,$tipoDoc,$usuario,$doc,$id){
      $res=$this->db->query("execute [editardoc] '".$nombre."','".$tipo_doc."',".$id_usuario.",'".$doc."',".$id);
      return $res->row_array();
    }
