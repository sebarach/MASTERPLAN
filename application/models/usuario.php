...
class usuario extends CI_model {
    ...
    function usuariosadd($usuario,$password,$id_perfil,$empresa,$activo,$nombre,$email){
    	$res=$this->db->query("execute [usuariosadd] '".$usuario."','".$password."',".$id_perfil.",".$empresa.",".$activo.",'".$nombre."','".$email."'");
   		return $res->row_array();
    }

    function usuariosedit($id,$usuario,$password,$id_perfil,$empresa,$activo,$nombre,$email){
    	$res=$this->db->query("execute [usuariosedit] ".$id.",'".$usuario."','".$password."',".$id_perfil.",".$empresa.",".$activo.",'".$nombre."','".$email."'");
   		return $res->num_rows();
    }
    ...
    function clave($usuario){
      $res=$this->db->query("execute [recuperar_clave] '".$usuario."'");
      return $res->row_array();
    }
