...
class clienteinfo extends CI_model {
    ...
    function clientesinfoadd($data){
        if(isset($data["clasificacion"])){
            $res=$this->db->query("execute [clientesinfoadd] ".$data["id_campana"].",".$data["id_accion"].",'".$data["id_cliente"]."','".$data["medicion"]."',".$data["acuerdo"].",".$data["implementado"].",".$data["id_motivo"].",'".$data["fecha_programada"]."','".$data["clasificacion"]."','".$data["tipo_acuerdo"]."','".$data["fecha_inicio_acuerdo"]."','".$data["fecha_fin_acuerdo"]."',0");
            return $res->result_array();
        } else {
    ...
    function clientesinfomatedit($data){
        if(isset($data["clasificacion"])){
            $res=$this->db->query("execute [clientesinfomatedit] ".$data["id_info"].",".$data["id_campana"].",".$data["id_accion"].",'".$data["id_cliente"]."','".$data["medicion"]."',".$data["acuerdo"].",".$data["implementado"].",".$data["id_motivo"].",'".$data["fecha_programada"]."','".$data["clasificacion"]."','".$data["tipo_acuerdo"]."','".$data["fecha_inicio_acuerdo"]."','".$data["fecha_fin_acuerdo"]."',0");
            return $res->row_array();
        } else {
