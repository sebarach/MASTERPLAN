...
class PHPMailer
{
     ...
     * @var string
     */
    public $From = 'root@masterplan.grupoprogestion.com';
     ...
     * 'masterplan.grupoprogestion.com.localdomain'.
     *
     * @var string
     */
    public $Hostname = '';
     ...
     * @var string
     */
    public $Host = 'masterplan.grupoprogestion.com';
     ...
     * Returns 'masterplan.grupoprogestion.com.localdomain' if unknown.
     *
     * @return string
     */
    protected function serverHostname()
    {
        ...
        if (!static::isValidHost($result)) {
            return 'masterplan.grupoprogestion.com.localdomain';
        }
