		...
		<main class="main" style="height: 100%; ">
			<div class="breadcrumb">
				<li class="breadcrumb-item ">
			        <a href="<?php  echo base_url("home"); ?>"><?php echo $empresa[0]["empresa"]; 
			        ?></a>
			    </li>
			...
			<div class="container-fluid ">
				<div class="animated fadeIn">
					...
					<div class="row">
						<div class="col-md-12">
							<form id="formsol" method="post" action="<?php echo site_url(); ?>solicitudes_ot/sot" class="row" style='padding-left: 9px;'>
								...
								<div class="col-md-1 col-b">
									...
									<div class="col-md-12" style="margin-top: 0.25rem; padding-left: 9px;">
										<button onclick="buscar()" class="btn btn-sm btn-theme"><i class="fa fa-search"></i></button>
										<a href="<?php echo base_url("solicitudes_ot/sot"); ?>" class="btn btn-sm btn-theme"><i class="fa fa-refresh"></i></a>
										...
										<button type="button" class="btn btn-sm btn-theme" data-toggle='modal' data-target='#modalsol' onclick='tar("sol_add","<?php echo $_SESSION["empresa"]; ?>")' ><i class="fa fa-plus"></i></button>
									</div>
								</form>
						</div>
						<div class="col-md-12">
								...
								<tbody>
									<?php 	
										foreach ($solicitudes as $s) {
											...
											echo "<td style='text-align:center;'><div class='btn-group btn-group-sm'>
												<button class='btn btn-sm btn-outline-theme' title='Ver Detalle' onclick='solicitud(\"".base64_encode($s["id_solicitud"])."\")' data-toggle='modal' data-target='#modaldetsol' ><i class='fa fa-eye'></i></button>";
											echo "<button class='btn btn-sm btn-outline-theme' data-toggle='modal' data-target='#modalchatsol' title='Mensajeria' onclick='chat(\"".base64_encode($s["id_solicitud"])."\")'><i class='fa fa-comments-o'></i></button>";
...
<div class="modal fade" id="modalsol"  role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
    	<div class="modal-content">
    		<div class="modal-header">
    			<h6 class="modal-title">Ingresar ot - <?php echo $empresa[0]["empresa"]?></h6> 
    			<button type="button" class="close" data-dismiss="modal" aria-label="Close">
    				<span aria-hidden="true">×</span>
    			</button> 
    		</div>        	
    		<form method="post" action="<?php echo base_url("solicitudes_ot/agregar"); ?>" enctype="multipart/form-data" onsubmit=" return valida_form('sol_add');">
    			<div class="modal-body">
    				<div class="row" style='padding-left: 9px;'>
    					<div class="col-md-1 col-ba">	        
    						<select class="form-control" name="lblanio" id="lblanio" style="width: 100%;">
    							...
    							foreach ($anios as $a) {
    								...
    								echo "<option value='".$a["anio"]."' ".$select.">".$a["anio"]."</option>";
    							}
    							if($c==count($anios)){
    					...
    					<div class="col-md-1 col-ba">	
    						<select class="form-control" name="lblmes" id="lblmes" style="width: 100%;">
    							<option value="">Mes</option>
    						</select>
    					</div>

    					<div class="col-md-1 col-ba">	
    						<select class="form-control" style="width: 100%;" id="lblcampana" name="lblcampana" onchange="mostrar()">
    					...
    					<div class="col-md-1 col-ba">	
    						<select class="form-control" style="width: 100%;" id="lblregion" name="lblregion">
    							<option value="">Region</option>
    						</select>
    					</div>

    					<div class="col-md-1 col-ba">	
    						<select class="form-control" style="width: 100%;" id="lblciudad" name="lblciudad">
    							<option value="">Ciudad</option>
    						</select>
    					</div>
    					<div class="col-md-3">   					
		    				<input type="text" name="lbl_cadenaadd" id="lbl_cadenaadd" placeholder="Cadena" class="form-control form2">				
    					</div>
    				</div>	

    				<div class="row " id="inputlocales"  style="display:none; margin-top: 0.8rem; padding-left: 4px;" >
    					<div class="col-md-12">
    						<div class="row">
    							<div class="col-md-4 form-group">
    								<div class="input-group">
		    							...
		    							<input type="text" name="nombrelocal" id="nombrelocal" placeholder="Ingrese nombre local" class="form-control"> 
		    						</div>
		    					</div>
		    					<div class="col-md-4 form-group">	
		    						<div class="input-group">
		    							...
		    							<input type="text" name="direccionlocal"  id="direccionlocal" placeholder="Ingrese direccion local" class="form-control"> 
		    						</div>
		    					</div>
    						</div>
    					</div>
    				</div>
    				<div class="row" id="inputlocal"  style="display:none; margin-top: 0.8rem; padding-left: 4px;">
    					<div class="col-md-12">
    						<div class="row">
    							<div class="col-md-3" id="localadd1">
		    						<select class="form-control" style="width: 100%;" id="lbl_localadd1" name="lbl_localadd1">
    				...
    				<div class="row" style="margin-top: 1.2rem; padding-left:4px;">
	    				<div class="col-md-5">  
	    					<div class="row">
	    						<div class="col-md-12 form-group">
		    						...
		    						<div class="input-group">
		    							...
		    							<input type="text" class="form-control" id="txt_asuntoadd" name="txt_asuntoadd">
		    						</div>
		    					</div>
		    					<div class="col-md-12 form-group" style="margin-top: 0.5rem;">
				    				<label>Comentario</label>
				    				<div class="input-group">
				    					<span class="input-group-addon bg-theme">
				    						<i class="fa fa-asterisk"></i>
				    					</span>
				    					<textarea class="form-control" rows="4" id="txt_comentarioadd" name="txt_comentarioadd" data-plugin="maxlength" data-placement="bottom-right-inside" maxlength="2000" ></textarea>	            				
				    				</div>
				    			...
				    			<div class="col-md-12 form-group" style="margin-top: 0.5rem;">
		    						...
		    						<div class="col-md-12 row form-group" id="duplicar">
		    							<div  class="col-md-12 row form-group file" >
		    								<div class="col-md-2">
		    						...
		    						<div class="col-md-12 row form-group" >
		    							<div class="btn-group">
		    								<label class="btn btn-sm btn-outline-theme" id="agregar" onclick="agregararch()"><i class="fa fa-plus"></i>Agregar </label>&nbsp;&nbsp;	    								

		    								<label class="btn btn-sm btn-outline-theme" style="display:none;" id="eliminar" onclick="eliminararch()"><i class="fa fa-times"></i>Quitar </label>
		    								<input type="hidden" name="duplicados" id="duplicados" value="1">
		    							</div>		
		    						</div>
	    				...
	    				<div class="col-md-7">
	    						<div class="form-group row" id="tareas">
	    						</div>
	    				</div>
	    			</div>    					
    			</div>
    			...
    			<div class="modal-footer">                
    				<button type="submit" id="btningresar" class="btn btn-theme"><i class='fa fa-save'></i>Guardar</button>
    			</div>
    		</form>
        </div>
    </div>
...
<div class="modal fade" id="modaldetsol"  role="dialog"  aria-hidden="true">
	 <div class="modal-dialog modal-lg" role="document">
	 	<div class="modal-content">
	 		<div class="modal-header">
...
<script type="text/javascript">
	$(function($){
		...
		$.ajax({
			...
			type: "POST",
			data: "anio="+$("#anioest").val()+"&mes="+$("#mesest").val(),
			dataType:"json",
				...
				processResults: function (data) {
					return {
						results: $.map(data, function(obj) {
							var id=<?php echo $mes_numero; ?>;
							if(id!=obj.mes_numero){
		...
		$("#campanasot").select2({
			ajax:{
				...
				type: "POST",
				data: function (term, page) {
		            return "anio="+$("#aniosot").val()+"&mes_numero="+$("#messot").val();
		        },
				dataType:"json",
				delay: 350,
				processResults: function (data) {
		...
		$("#region").select2({ 
			ajax:{
				...
				dataType:"json",
				data: function (term, page) {
		            return "id_campana="+$("#campanasot").val();
		        },
				delay: 350,
				processResults: function (data) {
					return {
		...
		$("#comuna").select2({
			ajax:{
				...
				type: "POST",
				data: function (term, page) {
		            return "id_campana="+$("#campanasot").val()+"&region="+$("#region").val();
		        },
				dataType:"json",
				delay: 350,
				processResults: function (data) {
		...
		$("#local").select2({ 
			ajax:{
				...
				type: "POST",
				data: function (term, page) {
		            return "id_campana="+$("#campanasot").val()+"&region="+$("#region").val()+"&cadena="+$("#cadena").val()+"&ciudad="+$("#comuna").val();
		        },
				dataType:"json",
				delay: 350,
				processResults: function (data) {
		...
		$("#lblcampana").select2({
			ajax:{
				...
				type: "POST",
				data: function (term, page) {
		            return "anio="+$("#lblanio").val()+"&mes_numero="+$("#lblmes").val();
		        },
				dataType:"json",
				delay: 350,
				processResults: function (data) {
		...
		$("#lblregion").select2({
			ajax:{
				...
				type: "POST",
				data: function (term, page) {
		            return "id_campana="+$("#lblcampana").val();
		        },
				dataType:"json",
				delay: 350,
				processResults: function (data) {
		...
		$("#lblciudad").select2({
			ajax:{
				...
				type: "POST",
				data: function (term, page) {
		            return "id_campana="+$("#lblcampana").val()+"&region="+$("#lblregion").val();
		        },
				dataType:"json",
				delay: 350,
				processResults: function (data) {
		...
		$("#lbl_localadd1").select2({ 
			ajax:{
				url:"<?php echo base_url("solicitudes_ot/locales"); ?>",
				type: "POST",
				data: function (term, page) {
		            return "id_campana="+$("#lblcampana").val()+"&region="+$("#lblregion").val()+"&ciudad="+$("#lblciudad").val();
		        },
				dataType:"json",
				delay: 350,
				processResults: function (data) {
		...
		$('textarea').maxlength({
			alwaysShow: true,
			threshold: 10,
			warningClass: "badge badge-boxed badge-primary",
	...
	function buscar(){
		$("#formsol").attr('action',"<?php echo base_url("solicitudes_ot/sot"); ?>");
		$("#formsol").submit();
	}
	...
	function tar(id,id_empresa){
		$.ajax({
			url:"http://masterplan.grupoprogestion.com/masterplan_prueba/solicitudes_ot/tareas",
			type: "POST",
			data: "id="+id_empresa,
			success: function(data){
				$("#tareas").html(data);
	...
	function mostrar(){
		var id_campana=$("#lblcampana").val();
		if (id_campana ==-1) {
			$("#inputlocales").show();
			$("#inputlocal").hide();
		}else if(id_campana>0){
			$("#inputlocales").hide();		
			$("#inputlocal").show();
		} else {
			$("#inputlocales").hide();		
	...
	// 	if(d>0){
	// 		var duplic='<div class="col-md-3 form-group">'+
	// 			'<label for="txt_archivosolicadd'+d+'" class="btn btn-theme btn-sm"><i class="fa fa-upload"></i>Archivo</label>'+
	// 			'<input type="file" style="display:none;" name="txt_archivosolicadd'+d+'" id="txt_archivosolicadd'+d+'" onchange="subirarchivo('+d+')">'+
	// 		'</div>';
	// 		$("#duplicar").html($("#duplicar").html()+duplic);
	// 		$("#eliminar").show();
	// 		d+=1;
	// 		$("#duplicados").val(d);
	// 	}	
