	            		...
	            		<div class="col-md-6">
	            			<div class="form-group">
	            				...
	            				<div class="input-group">
									...
									<input type="text" class="form-control" id="txt_nombreusuarioadd" name="txt_nombreusuarioadd" autocomplete="off">
	            				</div>
	            			</div>
	            		</div>
	            		<div class="col-md-6">
	            			<div class="form-group">
	            				...
	            				<div class="input-group">
									...
									<input type="text" class="form-control" id="txt_emailadd" name="txt_emailadd" autocomplete="off">
	            				</div>
	            			</div>
	            		</div>
	            	</div>
	            		...
	            		<div class="col-md-6">
	            			<div class="form-group">
	            				...
	            				<div class="input-group">
									...
									<input type="text" class="form-control" id="txt_nombreusuarioedit" name="txt_nombreusuarioedit" autocomplete="off">
	            				</div>
	            			</div>
	            		</div>
	            		<div class="col-md-6">
	            			<div class="form-group">
	            				...
	            				<div class="input-group">
									...
									<input type="text" class="form-control" id="txt_emailedit" name="txt_emailedit" autocomplete="off">
	            				</div>
	            			</div>
	            		</div>
	            	</div>
