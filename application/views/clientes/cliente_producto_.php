													...
													<tbody>
														<?php
															for($i=0;$i<count($productos);$i++){
																...
																echo "<td><input class='form-control' type='text' onchange='implemntados(".$i.")'  id='txt_implementado_".$i."' name='txt_implementado_".$i."' onfocus='num(".$i.")' value='".$m['Implementado']."' ></td>";
																echo "</tr>";
	...
	function ver_foto(id) {
		$.ajax({
			...
			success: function(data){
				...
				$("#modalfoto").find("img").attr("src","<?php echo base_url("archivos/fotos/"); ?>"+data.foto+"");
