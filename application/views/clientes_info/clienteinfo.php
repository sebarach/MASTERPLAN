														...
														<div class="col-md-3">
															<div class="form-group" style="margin-top:0.6rem;">
																...
																<?php if(base64_decode($_SESSION["empresa"])==9){
																		$macro=base_url("archivos/Macro_MasterP&G.xls");
																	} else {
																		$macro=base_url("archivos/Macro_Master.xls");
																	}

																?>
															
																<a href="<?php echo $macro; ?>" class="btn btn-theme"><i class="fa fa-download"></i><small>DESCARGAR MACRO MASTER</small></a>
															</div>
														</div>
														<div class="col-md-4">
	    ...
	    <div class="modal-dialog" role="document">
	        <div class="modal-content ">
	        	<div class="modal-header">
	        		<h6 class="modal-title">MASTER</h6>
	        	</div>
	    ...
	    $('#addC').on( 'click', function () {
	        ...
	        $(".fecha").daterangepicker({
			    ...
			    "locale": {
			  	...
			  	$('.fecha').val(chosen_date.format('DD-MM-YYYY'));		  
			});
