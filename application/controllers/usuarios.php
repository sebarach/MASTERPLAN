...
class usuarios extends CI_Controller {
	...
	public function agregar(){
		if(isset($_SESSION["sesion"])){
			...
			if((!isset($_POST["txt_nombreusuarioadd"])) || $_POST["txt_nombreusuarioadd"]==""){
			 	$vacios+=1;
			}
			if((!isset($_POST["txt_emailadd"])) || $_POST["txt_emailadd"]==""){
			 	$vacios+=1;
			}
			...
			if($vacios!=0){
				...
				$nombre=$_POST["txt_nombreusuarioadd"];
				$email=$_POST["txt_emailadd"];
				$add=$this->usuario->usuariosadd($usuario,$password,$id_perfil,$empresa,$activo,$nombre,$email);
	...
	public function editar(){
		if(isset($_SESSION["sesion"])){
			...
			if((!isset($_POST["txt_nombreusuarioedit"])) || $_POST["txt_nombreusuarioedit"]==""){
			 	$vacios+=1;
			}
			if((!isset($_POST["txt_emailedit"])) || $_POST["txt_emailedit"]==""){
			 	$vacios+=1;
			}
			...
			if($vacios!=0){
				...
				$nombre=$_POST["txt_nombreusuarioedit"];
				$email=$_POST["txt_emailedit"];
				$this->usuario->usuariosedit($id,$usuario,$password,$id_perfil,$empresa,$activo,$nombre,$email);
