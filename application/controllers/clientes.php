	...
	function __construct()
    {
	 ...
	 function index(){ 
		...
		if(isset($_SESSION["sesion"])){
			...
			if($_SESSION["perfil"]==0 || $_SESSION["perfil"]==5){
	...
	public function addFoto(){
		...
		if($vacios!=0){
			...
			if(isset($_POST["id"])){
				...
				$nom_foto=date("dmYHis").$id_campana.$id_accion.$id_cliente.'_'.base64_encode($nombre);
				$foto=$this->subir_Foto($nom_foto);
