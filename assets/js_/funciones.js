...
function valida_form(form){
	...
	switch(form){
		case 'e_add':
			...
			} else if(document.getElementById("txt_coloresadd1").value==""){
				vacios+=1;
				alert('Debe selecccionar el color principal del Entorno.');
				document.getElementById("txt_coloresadd1").focus();
			} else if(document.getElementById("txt_coloresadd2").value==""){
				vacios+=1;
				alert('Debe selecccionar el primer color para dashboard.');
				document.getElementById("txt_coloresadd2").focus();
			} else if(document.getElementById("txt_coloresadd3").value==""){
				vacios+=1;
				alert('Debe selecccionar el segundo color para dashboard.');
				document.getElementById("txt_coloresadd3").focus();
			} else if(document.getElementById("txt_logoadd").value==""){
				vacios+=1;
				alert('Debe ingresar una imagen del logo del cliente.');
				document.getElementById("txt_logoadd").focus();
			} else if(document.getElementById("txt_fondoadd").value==""){
				vacios+=1;
				alert('Debe ingresar una imagen de fondo para dashboard.');
				document.getElementById("txt_fondoadd").focus();
			} else {
				var logo=(document.getElementById("txt_logoadd").value.substring(document.getElementById("txt_logoadd").value.lastIndexOf("."))).toLowerCase();
				var fondo=(document.getElementById("txt_fondoadd").value.substring(document.getElementById("txt_fondoadd").value.lastIndexOf("."))).toLowerCase();
				if(document.getElementById("txt_coloresadd1").value=="#000000" &&
					document.getElementById("txt_coloresadd2").value=="#000000" &&
					document.getElementById("txt_coloresadd3").value=="#000000"){
					vacios+=1;
					alert('Debe selecccionar por lo menos un color, ya que los tres colores no pueden ser Negro');
				} else if(logo!==".jpg" || logo!==".png" || logo!==".jpeg"){
					vacios+=1;
					 alert("La imagen ingresada debe tener una extensión .jpg, .png, .jpeg.");
					document.getElementById("txt_logoadd").focus();
				} else if(fondo!==".jpg" || fondo!==".png" || fondo!==".jpeg"){
					vacios+=1;
					 alert("La imagen ingresada debe tener una extensión .jpg, .png, .jpeg.");
					document.getElementById("txt_fondoadd").focus();
				}
		...
		case 'e_edit':
			...
			} else if(document.getElementById("txt_coloresedit1").value==""){
				vacios+=1;
				alert('Debe selecccionar el color principal del Entorno.');
				document.getElementById("txt_coloresedit1").focus();
			} else if(document.getElementById("txt_coloresedit2").value==""){
				vacios+=1;
				alert('Debe selecccionar el primer color para dashboard.');
				document.getElementById("txt_coloresedit2").focus();
			} else if(document.getElementById("txt_coloresedit3").value==""){
				vacios+=1;
				alert('Debe selecccionar el segundo color para dashboard.');
				document.getElementById("txt_coloresedit3").focus();
			} else if((document.getElementById("txt_logo").value=="") ){
				vacios+=1;
				alert('Debe ingresar una imagen del logo del cliente.');
				document.getElementById("txt_logoedit").focus();
			} else if((document.getElementById("txt_fondo").value=="") ){
				vacios+=1;
				alert('Debe ingresar una imagen de fondo para dashboard.');
				document.getElementById("txt_fondoedit").focus();
			} else {
				if(document.getElementById("txt_coloresedit1").value=="#000000" &&
					document.getElementById("txt_coloresedit2").value=="#000000" &&
					document.getElementById("txt_coloresedit3").value=="#000000"){
					vacios+=1;
					alert('Debe selecccionar por lo menos un color, ya que los tres colores no pueden ser Negro');
				} else if(document.getElementById("txt_logoedit").value!=""){
					var allowedExtensions = /(.jpg|.jpeg|.png|.gif)$/i;
    				if(!allowedExtensions.exec(document.getElementById("txt_logoedit").value)){
					// var logo=(document.getElementById("txt_logoedit").value.substring(document.getElementById("txt_logoedit").value.lastIndexOf("."))).toLowerCase();
					// if(logo!=".jpg" || logo!=".png" || logo!=".jpeg"){
						vacios+=1;
						 alert("La imagen ingresada debe tener una extensión .jpg, .png, .jpeg.");
						document.getElementById("txt_logoedit").focus();
					}
				} else if(document.getElementById("txt_fondoedit").value!=""){
					var allowedExtensions = /(.jpg|.jpeg|.png|.gif)$/i;
    				if(!allowedExtensions.exec(document.getElementById("txt_fondoedit").value)){
						vacios+=1;
						 alert("La imagen ingresada debe tener una extensión .jpg, .png, .jpeg.");
						document.getElementById("txt_fondoedit").focus();
					}
...
function limpiar(form){
	switch(form){
		...
		case 'e_add':
			...
			document.getElementById("txt_coloresadd1").value="";
			document.getElementById("txt_coloresadd2").value="";
			document.getElementById("txt_coloresadd3").value="";
...
function empresa(id){
	$.ajax({
		...
		success: function(data){
			document.getElementById("txt_empresaedit").value=data.empresa;
			document.getElementById("txt_coloresedit1").value=data.color_principal;
			document.getElementById("txt_coloresedit2").value=data.color_grafico_1;
			document.getElementById("txt_coloresedit3").value=data.color_grafico_2;
			document.getElementById("txt_fondo").value=data.imagen_fondo;
			document.getElementById("txt_logo").value=data.imagen_logo;
			var fondo=$('#txt_fondoedit').dropify();
			fondo=fondo.data('dropify');	
			fondo.resetPreview();
			fondo.clearElement();		
			if(data.imagen_fondo!==null){				
				fondo.settings.defaultFile = 'http://masterplan.grupoprogestion.com/masterplan/archivos/fondos/'+data.imagen_fondo;				
			} else{
			...
			logo.resetPreview();
			logo.clearElement();
			if(data.imagen_logo!==null){
				logo.settings.defaultFile = 'http://masterplan.grupoprogestion.com/masterplan/archivos/logos/'+data.imagen_logo;				
			} else{
