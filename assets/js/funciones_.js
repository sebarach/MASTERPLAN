...
function valida_form(form){
	...
	switch(form){
		case 'e_add':
			...
			} else if(document.getElementById("chck_color").checked==true){
				if(document.getElementById("txt_coloresadd1").value=="" && document.getElementById("txt_coloresadd2").value==""
			...
			} else if(document.getElementById("chck_logo").checked==true){
				var allowedExtensions = /(.jpg|.jpeg|.png|.gif)$/i;
				if(document.getElementById("txt_logoadd").value==""){
					vacios+=1;
					alert('Debe seleccionar una foto para el logo de los dashboard. En caso contrario, desmarque la casilla Habilitar Imagen Logo');
					document.getElementById("txt_logoadd").focus();
				} else if(!allowedExtensions.exec(document.getElementById("txt_logoadd").value)){
					vacios+=1;
					 alert("La imagen ingresada debe tener una extensión .jpg, .png, .jpeg.");
					document.getElementById("txt_logoadd").focus();
				}
			} else if(document.getElementById("chck_fondo").checked==true){
				var allowedExtensions = /(.jpg|.jpeg|.png|.gif)$/i;
				if(document.getElementById("txt_fondoadd").value==""){
					vacios+=1;
					alert('Debe seleccionar una foto para el fondo de los dashboard. En caso contrario, desmarque la casilla Habilitar Imagen Fondo');
					document.getElementById("txt_fondoadd").focus();
				} else if(!allowedExtensions.exec(document.getElementById("txt_fondoadd").value)){
					vacios+=1;
					 alert("La imagen ingresada debe tener una extensión .jpg, .png, .jpeg.");
					document.getElementById("txt_fondoadd").focus();
				}
		...
		case 'e_edit':
			...
			} else if(document.getElementById("chck_color1").checked==true){
				if(document.getElementById("txt_coloresedit1").value=="" && document.getElementById("txt_coloresedit2").value==""
				 && document.getElementById("txt_coloresedit3").value==""){
				 	vacios+=1;
					alert('Debe seleccionar el color principal para de los dashboard. En caso contrario, desmarque la casilla Habilitar Colores');
					document.getElementById("txt_coloresedit1").focus();
				}
			} else if(document.getElementById("chck_logo1").checked==true){
				var allowedExtensions = /(.jpg|.jpeg|.png|.gif)$/i;
				if(document.getElementById("txt_logo").value==""){
					if(document.getElementById("txt_logoedit").value==""){
						vacios+=1;
						alert('Debe seleccionar una foto para el logo de los dashboard. En caso contrario, desmarque la casilla Habilitar Imagen Logo');
						document.getElementById("txt_logoedit").focus();
					} else if(!allowedExtensions.exec(document.getElementById("txt_logoedit").value)){
						vacios+=1;
						 alert("La imagen ingresada debe tener una extensión .jpg, .png, .jpeg.");
						document.getElementById("txt_logoedit").focus();
					}
				}
			} else if(document.getElementById("chck_fondo1").checked==true){
				var allowedExtensions = /(.jpg|.jpeg|.png|.gif)$/i;
				if(document.getElementById("txt_fondo").value==""){
					if(document.getElementById("txt_fondoedit").value==""){
						vacios+=1;
						alert('Debe seleccionar una foto para el fondo de los dashboard. En caso contrario, desmarque la casilla Habilitar Imagen Fondo');
						document.getElementById("txt_fondoedit").focus();
					} else if(!allowedExtensions.exec(document.getElementById("txt_fondoedit").value)){
						vacios+=1;
						 alert("La imagen ingresada debe tener una extensión .jpg, .png, .jpeg.");
						document.getElementById("txt_fondoedit").focus();
					}
